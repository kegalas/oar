...
geo::vec4f cameraPos = {0.f, 0.f, 2.0f, 1.f};
...
void drawSQ(){
    ...
    geo::mat4f persp = geo::perspective(2.9f,-1000.f);
    ...
    for(int i=0;i<nface;i++){
        ...
        for(int j=0;j<3;j++){
            ...
            tcoords.screenCoords[j] = persp * tcoords.camCoords[j];
...
void drawTeaPot(){
    ...
    geo::mat4f mod = geo::rotateY(-PI/12.f)*geo::rotateX(PI/3.f*2.f);
